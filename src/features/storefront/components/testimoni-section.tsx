  ...
  return (
    <section className="relative overflow-hidden py-12 sm:py-14">
      ...
      <div className="mx-auto w-full max-w-[1480px] px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative overflow-hidden rounded-[2rem] border border-primary/15 bg-card/40 py-5 shadow-[0_24px_90px_hsl(var(--background)_/_0.42)] backdrop-blur-sm sm:py-6">
          <div className="relative z-10">
            <div className="testimoni-strip-mask overflow-hidden">
              <div className="testimoni-strip-track flex w-max gap-3 px-3 sm:gap-4 sm:px-4">
                {loopedTestimonials.map((item, index) => (
                  <div
                    key={`${item.alt}-${index}`}
                    className="shrink-0 overflow-hidden rounded-[1.2rem] border border-primary/18 bg-background/78 shadow-[0_14px_38px_hsl(var(--background)_/_0.36)]"
                  >
                    <Image
                      src={item.src}
                      alt={item.alt}
                      className="block h-auto w-[138px] object-cover sm:w-[176px] lg:w-[212px]"
