...
export default function ProductCard({
  ...
  return (
    <motion.div
      ...
      className={`group relative flex h-full cursor-pointer flex-col overflow-hidden rounded-[1.2rem] border border-border/40 bg-card/85 backdrop-blur-sm transition-all duration-300 hover:border-primary/40 hover:box-glow sm:rounded-[1.75rem] ${
    ...
    >
      ...
      <div className="relative aspect-[4/5] overflow-hidden bg-[radial-gradient(circle_at_top,_hsl(var(--primary)/0.24),_transparent_58%),linear-gradient(180deg,_hsl(var(--secondary)/0.9),_hsl(var(--card)))] p-2 sm:p-3">
        ...
        <div className="absolute inset-x-2 top-2 flex flex-col items-start gap-1.5 sm:inset-x-6 sm:top-6 sm:flex-row sm:flex-wrap sm:items-start sm:justify-between sm:gap-2">
          <div className="relative flex max-w-full min-w-0 items-center gap-1.5 rounded-[0.85rem] border border-primary/45 bg-[linear-gradient(135deg,_hsl(var(--primary)/0.28),_hsl(var(--background)/0.96)_42%,_hsl(var(--background)/0.94)_100%)] px-2.5 py-2 shadow-[0_0_22px_hsl(var(--primary)/0.22)] backdrop-blur-md sm:max-w-[68%] sm:gap-2 sm:rounded-[1.2rem] sm:px-4 sm:py-3">
          ...
          <div className="relative rounded-[0.85rem] border border-primary/45 bg-[linear-gradient(135deg,_hsl(var(--primary)/0.28),_hsl(var(--background)/0.96)_42%,_hsl(var(--background)/0.94)_100%)] px-2.5 py-2 text-right shadow-[0_0_22px_hsl(var(--primary)/0.22)] backdrop-blur-md sm:rounded-[1.2rem] sm:px-4 sm:py-3">
            <div className="absolute inset-x-3 top-0 h-px bg-gradient-to-r from-transparent via-primary/80 to-transparent" />
            <p
        ...
        <div className="absolute inset-x-2 bottom-2 flex justify-start sm:inset-x-6 sm:bottom-6">
          <div className="relative rounded-[0.95rem] border border-primary/45 bg-[linear-gradient(135deg,_hsl(var(--primary)/0.28),_hsl(var(--background)/0.96)_42%,_hsl(var(--background)/0.94)_100%)] px-3 py-2 text-right shadow-[0_0_22px_hsl(var(--primary)/0.22)] backdrop-blur-md sm:rounded-[1.2rem] sm:px-4 sm:py-3">
            <div className="absolute inset-x-3 top-0 h-px bg-gradient-to-r from-transparent via-primary/80 to-transparent" />
        ...
        <div className="mt-auto flex flex-col gap-4">
          {!isSold && (
            <a
              ...
              className="flex w-full items-center justify-center gap-1.5 rounded-[0.95rem] bg-primary px-2 py-2.5 text-center font-display text-[10px] font-bold tracking-[0.08em] text-primary-foreground transition-all duration-300 hover:box-glow-strong sm:gap-2 sm:rounded-[1.15rem] sm:px-4 sm:py-3.5 sm:text-sm sm:tracking-[0.16em]"
            >
